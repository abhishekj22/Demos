...
public class CustomerBean implements java.io.Serializable{
	...
	public boolean authenticate(String customerId, String password) throws Exception{
	...
	public int order(int productNo, int quantity) throws Exception{
		Context naming = new InitialContext();
		DataSource ds = (DataSource)naming.lookup("jdbc/SalesDB");
		try(Connection con = ds.getConnection()){
	...
	public static class InvoiceEntry{
		...
		InvoiceEntry(ResultSet rs) throws Exception{
