...
static class Program
{
	...
	*/
	...
	// this method will return using await statement
	private static async Task DoComputation()
	{
		Console.Write("Computing...");
		
		Computation c = new Computation();
		long r = await c.ComputeAsync(1, 20); // task will be returned to the caller				
		
		// this code will execute after awaited task completes 
		Console.WriteLine("Done!");
		Console.WriteLine("Result = {0}", r);
	}
